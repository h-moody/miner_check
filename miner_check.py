...
parser.add_argument('--max_temp_e9', type=int, default=84, help='Maximum CHIP temperature for E9 Pro miners')
parser.add_argument('--max_temp_l7', type=int, default=80, help='Maximum CHIP temperature for L7 miners')
